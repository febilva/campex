...
class CourseTypesControllerTest < ActionController::TestCase
  ...
  test "should create course_type" do
    assert_difference('CourseType.count') do
      post :create, course_type: { code: @course_type.code, department_id: @course_type.department_id, name: @course_type.name }
    end
  ...
  test "should update course_type" do
    patch :update, id: @course_type, course_type: { code: @course_type.code, department_id: @course_type.department_id, name: @course_type.name }
    assert_redirected_to course_type_path(assigns(:course_type))
  end
