...
class MarksControllerTest < ActionController::TestCase
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post :create, mark: { entered_by: @mark.entered_by, mark: @mark.mark, registered_exam_paper_id: @mark.registered_exam_paper_id }
    end
  ...
  test "should update mark" do
    patch :update, id: @mark, mark: { entered_by: @mark.entered_by, mark: @mark.mark, registered_exam_paper_id: @mark.registered_exam_paper_id }
    assert_redirected_to mark_path(assigns(:mark))
  end
